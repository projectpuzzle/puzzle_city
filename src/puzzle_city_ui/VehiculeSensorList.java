...
//	}
	 ...
	 */
	public VehiculeSensor(Client socket) {
		client = socket;
		initialize();
...
//		//set data  for table	
		...
		tblvehiculesensor = new JTable(new DefaultTableModel(new Object[][] {}, new String[] { "ID", "Address" }) {
		...
		tblvehiculesensor.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				int ID = Integer.parseInt(tblvehiculesensor.getModel().getValueAt(row, 0).toString());

				Dashboard ctDetail = new Dashboard(client, ID);
