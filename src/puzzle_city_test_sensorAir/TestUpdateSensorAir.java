...
public class TestUpdateSensorAir {
	...
	Object obj;
	try {
		obj = parser.parse(new FileReader("src\\puzzle_city_test_sensorAir\\TestUpdateSensorAir.json"));
		...
		int alert_id=Integer.valueOf(jsonObject.get("alert_id").toString());
		String address =jsonObject.get("address").toString();
		boolean alert =Boolean.valueOf(jsonObject.get("alert").toString());
